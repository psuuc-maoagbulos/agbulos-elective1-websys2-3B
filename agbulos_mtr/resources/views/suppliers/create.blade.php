...
@section('title', 'Register a Supplier')
...
<style>
    ...
    .btn-save {
        background-color: #28a745; /* Green for Save/Register button */
        border-color: #28a745;
    ...
    <div class="form-container">
        <div class="card shadow-lg border-0 animate__animated animate__fadeIn">
            <div class="card-header py-3">
                <h5 class="mb-0 fw-semibold text-white">Register a Supplier</h5>
            </div>
                ...
                <form action="{{ route('suppliers.store') }}" method="POST" novalidate>
                    ...
                    <div class="btn-group-form">
                        <button type="submit" class="btn btn-save px-4">
                            <i class="bi bi-save me-2"></i>Register Supplier
                        </button>
